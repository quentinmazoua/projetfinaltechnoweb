...
if(isset($proprietes))
{
    ...
    foreach($proprietes as $propriete)
    {
        ...
        echo '<td>'.$propriete["adresse"].'</td><td>'.$propriete["pays"].'</td><td>'.$propriete["ville"].'</td><td>'.$date.'</td><td><a href="#">Voir</a></td><td><a href="#"><font color="blue"><span class="glyphicon glyphicon-pencil"></span></font></a><font size="4">/</font><a href="#"><font color="red"><span class="glyphicon glyphicon-trash"></span></font></a></td>';
        echo '</tr>';
    }
